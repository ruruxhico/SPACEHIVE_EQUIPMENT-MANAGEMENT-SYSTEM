            ...
            <div class="card shadow border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <!-- Profile Info -->
                        <div class="flex-grow-1 ms-4 pl-4"> <!-- pl-4 for Bootstrap 4 spacing -->
                            <h2 class="fw-bold text-primary mb-0">
                                <?= esc($student['last_name']) ?>, <?= esc($student['first_name']) ?> <?= esc($student['middle_name']) ?>
                            </h2>
                            <p class="text-muted mb-1"><?= esc($student['school_id']) ?> | <span class="badge bg-info text-dark"><?= esc($student['role']) ?></span></p>
                            <p class="small text-secondary mb-3"><?= esc($student['email']) ?></p>
                            
                            <!-- Action Buttons -->
                            <div class="d-flex gap-2">
                                <!-- Edit Profile -->
                                <a href="<?= base_url('users/edit/' . $student['school_id']) ?>" class="btn btn-outline-primary btn-sm mr-2">
