        ...
        <div class="card-body p-4">
            ...
            <form action="<?= base_url('equipment/insert') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="remarks" class="form-control" rows="3" placeholder="Optional notes (e.g. Brand new, Donation, etc.)"></textarea>
                </div>
...
<script>
    ...
    document.getElementById('typeSelect').addEventListener('change', function() {
        document.getElementById('accessoryDisplay').value = this.options[this.selectedIndex].getAttribute('data-accessories');
    });
</script>